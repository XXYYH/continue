...
import saver
from models2 import TransformerModel, network_paras
...
parser.add_argument("--out_dir", default='./songs', type=str)
parser.add_argument("--epochs", default="2", type=int)

parser.add_argument("--data_npz", type=str)
parser.add_argument("--dict_pkl", type=str)
parser.add_argument("--map_json", type=str)
parser.add_argument("--idx_npz", type=str)
parser.add_argument("--trained_ckpt", type=str)
parser.add_argument("--stop_loss", default=0.05, type=float)
...
path_train_data = '/home/y202684/pro/dataset/train_data_linear.npz'
path_dictionary = '/home/y202684/pro/dataset/dictionary.pkl'
path_train_idx = '/home/y202684/pro/dataset/train_fn2idx_map.json'
path_train_data_cls_idx = '/home/y202684/pro/dataset/train_data_linear_data_idx.npz'

path_train_data = args.data_npz
path_dictionary = args.dict_pkl
path_train_idx = args.map_json
path_train_data_cls_idx = args.idx_npz
...
def train():
    ...
    if args.trained_ckpt:
        ...
        path_saved_ckpt = args.trained_ckpt
    ...
    for epoch in range(n_epoch):
        ...
        for bidx, (batch_x, batch_y, batch_mask) in enumerate(train_loader):  # num_batch
            ...
            if args.data_parallel > 0:
                ...
                loss = (losses[0] + losses[1] + losses[2] + losses[3] + losses[4] + losses[5] + losses[6] + losses[
                    7]) / 8
            ...
            if args.data_parallel > 0:
                ...
                sys.stdout.write(
                    '{}/{} | Loss: {:06f} | {:04f}, {:04f}, {:04f}, {:04f}, {:04f}, {:04f}, {:04f}, {:04f}\r'.format(
                        bidx, num_batch, loss, calculated_loss[0], calculated_loss[1], calculated_loss[2],
                        calculated_loss[3], calculated_loss[4], calculated_loss[5], calculated_loss[6],
                        calculated_loss[7]))
                sys.stdout.flush()
